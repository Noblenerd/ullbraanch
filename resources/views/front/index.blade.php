...
<html lang="en">
    ...
    <head>
        ...
        <title>ULLWEB Link Shortener </title>
        ...
        <nav class="navbar navbar-expand-sm d-flex justify-content-between text-white navbar-light bg-transparent fixed-top">
            <div class="navbar-brand ml-5">
                <a href="index.php" style="text-decoration:none;">	
                    <h3 class="text-white animated fadeInLeft"> Link Shortener </h3>
                </a>
            </div> 
        </nav>
        <div class="container-fluid mx-0 px-0">
            <div class="owl-carousel banner mx-0 px-0">
                <div align="center" class="item" style="background:linear-gradient(45deg,rgba(12,12,12,0.5),rgba(13,13,13,0.7)),url(images/1.jpg) center center;height:100vh;padding-top:15%;">
                    <h1 align="center" class="pt-5 px-1 text-white" style="font-size:55px;">    Shorten your link with ease </h1>
        ...
        <div class="container my-5">
            <div class="row">
                ...
                <div class="col-md-5">
                    ...
                    <h4 align="center"> Shorten your link </h4><br>
                    <form method="post" action="{{url('get/shorten')}}">
                        @csrf
