        ...
        <div class="container my-5">
            <div class="row">
                ...
                <div class="col-md-5">
                    ...
                    <h4 align="center"> QRcode Generator </h4><br>
                    <form method="post" action="{{url('get/qrcode')}}">
                        @csrf
                        <div class="form-group">
                            <div class="input-group">
                                <select size="1" name="type" class="form-control" onchange="check(this.value)">
                        ...
                        <div class="form-group text">
                            <div class="input-group">
                                <input type="text" name="text" class="form-control" placeholder="Enter the Text">
                            </div>
                        </div>
                        <div class="phone">
                            <div class="form-group">
                                <div class="input-group">
                                    <input type="tel" name="pphone" class="form-control" placeholder="Enter the Phone Number">
                                </div>
                            </div>
                        </div>
                        <div class="sms">
                            <div class="form-group">
                                <div class="input-group">
                                    <input type="tel" name="sphone" class="form-control" placeholder="Enter the SMS Phone Number">
                                </div>
                            </div>
                            <div class="form-group">
                                <div class="input-group">
                                    <input type="text" name="smsg" class="form-control" placeholder="Enter the SMS Message">
                                </div>
                            </div>
                        </div>
                        <div class="contact">
                            <div class="form-group">
                                <div class="input-group">
                                    <input type="text" name="cname" class="form-control" placeholder="Enter the Contact Name">
                                </div>
                            </div>
                            <div class="form-group">
                                <div class="input-group">
                                    <input type="text" name="caddress" class="form-control" placeholder="Enter the Contact Address">
                                </div>
                            </div>
                            <div class="form-group">
                                <div class="input-group">
                                    <input type="tel" name="cphone" class="form-control" placeholder="Enter the Contact Phone Number">
                                </div>
                            </div>
                            <div class="form-group">
                                <div class="input-group">
                                    <input type="email" name="cemail" class="form-control" placeholder="Enter the Contact Email">
                                </div>
                            </div>
                        </div>
